...
/*
Problem-34 Reverse the linked list in pairs. If you have a linked list that holds 1
            ...
            case 11:if(iSLLlengthEven(head)==0)
                    {
                        ...
                        printf("ODD LENGTH\n");
                    break;
            case 12:head=reversePairIterative(head); 
                    break;
...
{
    Node *temp=0;
    //base case for empty or 1 element list
    ...
    else
    {
        ...
        head->next=reversePairRecursive(head->next);
        return temp;
    }
}
