...
void findLoop2(Node *hptr)
{
    ...
    Node *slowPtr=hptr,*fastPtr=hptr;
...
/*
prog14:
check whether the given L.L. is null terminated or
 not .if there is a cycle find the length of
 the loop
*/
...
void main()
{
    ...
    while(1)
    {
        ...
        switch(op)
        {
            ...
            case 11:findLoopLength(head);break;
