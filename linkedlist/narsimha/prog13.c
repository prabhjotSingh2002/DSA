...
/*
problem 31:Given two sorted L.L., we need to 
merge them into them into the third list in sorted
order
*/
            ...
            case 11:if(iSLLlengthEven(head)==0)
                    {
                        ...
                        printf("ODD LENGTH\n");
                    break;
            case 12:head2=MergeList(head,head1);
                    display(head2);
                    break;
